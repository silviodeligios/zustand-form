...
export function computeNewIndex(index: number, op: ArrayReindexOp): number | null {
  if (op.type === 'remove') {
...
export function parsePathIndex(key: string, prefix: string): { index: number; suffix: string } | null {
